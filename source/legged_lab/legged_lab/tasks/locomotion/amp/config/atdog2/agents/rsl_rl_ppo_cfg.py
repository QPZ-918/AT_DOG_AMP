...
from legged_lab.tasks.locomotion.amp.mdp.symmetry import atdog2


@configclass
class ATDog2RslRlOnPolicyRunnerAmpCfg(RslRlOnPolicyRunnerCfg):
    class_name = "AMPRunner"
    num_steps_per_env = 24
    max_iterations = 50000
    save_interval = 200
    experiment_name = "atdog2_amp"
    obs_groups = {
        "policy": ["policy"],
        "critic": ["critic"],
        "discriminator": ["disc"],
    ...
    algorithm = RslRlPpoAmpAlgorithmCfg(
        ...
        symmetry_cfg=RslRlSymmetryCfg(
            ...
            data_augmentation_func=atdog2.compute_symmetric_states,
